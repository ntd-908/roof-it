...
(function () {
    ...
    var isFigure = function (elm) {
        ...
        return elm.classList.contains("img-native-wrap");
    };
    ...
    var getSelectedImage = function (editor) {
        ...
        var figureElm = editor.dom.getParent(imgElm, '.img-native-wrap');
        if (figureElm) {
    ...
    var splitTextBlock = function (editor, figure) {
        ...
        var textBlockElements = filter(editor.schema.getTextBlockElements(), function (_, parentElm) {
            ...
            return !editor.schema.isValidChild(parentElm, 'span');
        });
    ...
    var deleteImage = function (editor, image) {
        if (image) {
            ...
            var elm = editor.dom.is(image.parentNode, '.img-native-wrap') ? image.parentNode : image;
    ...
    var changeHandler = function (helpers, info, state) {
        return function (api, evt) {
            if (evt.name === 'src' || evt.name === 'caption') {
                changeSrc(helpers, info, state, api);
    ...
    var register$1 = function (editor) {
        editor.ui.registry.addToggleButton('image', {
            ...
            onSetup: function (buttonApi) {
                ...
                return editor.selection.selectorChangedWithUnbind('img:not([data-mce-object],[data-mce-placeholder]),span.img-native-wrap', buttonApi.setActive).unbind;
            }
        });
